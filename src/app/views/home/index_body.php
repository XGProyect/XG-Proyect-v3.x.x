...
<body>
    <div id="start">
        ...
        <div id="content" class="clearfix">
            <div id="subscribe">
                <form id="subscribeForm" class="" name="subscribeForm" method="POST" onsubmit="changeAction('register','subscribeForm');" action="" autocomplete="off">
                    ...
                    <div class="input-wrap">
                        <div class="input-wrap">
                            ...
                            <div class="black-border">
                                <input class="validate[required,custom[email]]" type="text" id="email" name="email" value="{user_email}">
                            </div>
                        </div>
                    </div>
                    <div class="input-wrap">
                        ...
                        <div class="black-border">
                            <input class="validate[required,custom[pwLength]]" type="password" id="password" name="password" autocomplete="new-password" value="" maxlength="20" aria-autocomplete="list">
                        </div>
                    ...
                    <div class="input-wrap first">
                        <label for="server">{hm_universe} (<a class="overlay" data-type="ajax" href="index.php?page=universe">{hm_distinctions}</a>)</label>
                        <div id="server" style="position:relative;">
                            <table cellspacing="0" cellpadding="0" onclick="switch_uni_selection()" onmouseover="this.style.cursor='pointer'" class="server_table" style="cursor: pointer;">
                                <tbody>
                                    <tr>
                                        <td id="uni_select_box" class="exodus-server-new" style="height:19px;overflow:hidden;">
                                            <span id="uni_name" class="margin-uni-selection">{hm_universe_name}</span>
                                        </td>
                                        <td style="width:18px; background: url(public/images/home/dropdownmenu_arrow.png) no-repeat scroll 0 0 #8D9AA7;"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <input class="js_uniUrl" type="hidden" name="uni_url" id="uni_domain" value="s123-ar.ogame.gameforge.com">
                            <div id="uni_selection" style="display: none;">
                                <script type="text/javascript">
                                    select_uni('{base_path}'.replace('http://', '').replace('https://', ''), '{hm_universe_name}', '');
                                </script>

                                <div id="row-0" class="server-row exodus-server-new uni_span margin-uni-selection" title="" onclick="select_uni('{base_path}', '{hm_universe_name} ','exodus-server-new');" onmouseover="highlightRow('row-0');this.style.cursor='pointer'" onmouseout="unHighlightRow('row-0');" data-tooltip="">
                                    {hm_universe_name} </div>
                            </div>
                        </div>
                    ...
                    <div class="input-wrap expand">
                        ...
                        <div>
                            <input type="submit" id="regSubmit" value="{hm_register}">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div id="fancybox-wrap">
        <div id="fancybox-outer">
            ...
            <div id="fancybox-inner"></div><a id="fancybox-close"></a><a href="javascript:;" id="fancybox-left"><span class="fancy-ico" id="fancybox-left-ico"></span></a><a href="javascript:;" id="fancybox-right"><span class="fancy-ico" id="fancybox-right-ico"></span></a>
        </div>
    </div>
</body>
