        ...
        <tr class="header">
            <td class="header" style="width:5;">
                <table class="header">
                    <tr class="header">
                        <td class="header">
                            <img src="{{ $dpath }}planets/small/s_{{ $image }}.jpg" height="50"
                                width="50">
                        </td>
                        <td class="header">
                            <table class="header">
            ...
            <td class="header">
                <table class="header" id="resources" cellspacing="0" cellpadding="0" padding-right="30">
                    <tr class="header" style="text-align:center">
                        ...
                        <td width="85" class="header">
                            <img src="{{ $dpath }}resources/darkmatter.jpg" width="42" height="22"
                                title="Dark Matter">
                        </td>
                        <td width="85" class="header">
                            <img src="{{ $dpath }}resources/energy.gif" width="42" height="22">
                    ...
                    <tr class="header">
                        <td style="margin: 0 auto;" width="35px" class='header'>
                            <a href="game.php?page=officier" accesskey="o">
                                <img style="border:0;"
                                    src="{{ $dpath }}premium/commander_ikon{{ $img_premium_officier_commander }}.gif"
                                    width="32" height="32" alt="{{ $of_hire_commander }}"
                        ...
                        <td style="margin: 0 auto;" width="35" class="header">
                            <a href="game.php?page=officier" accesskey="o">
                                <img style="border:0;"
                                    src="{{ $dpath }}premium/admiral_ikon{{ $img_premium_officier_admiral }}.gif"
                                    width="32" height="32" alt="{{ $of_hire_admiral }}"
                                    onmouseover="return overlib('<table width=390px><tr><td class=c>{{ $of_hire_admiral }}</td></tr><tr><th style=text-align:left>{{ $add_premium_officier_admiral }}</th></tr></table>');"
                                    onmouseout="return nd();">
                            </a>
                        </td>
                        <td style="margin: 0 auto;" width="35" class="header">
                            <a href="game.php?page=officier" accesskey="o">
                                <img style="border:0;"
                                    src="{{ $dpath }}premium/ingenieur_ikon{{ $img_premium_officier_engineer }}.gif"
                                    width="32" height="32" alt="{{ $of_hire_engineer }}"
                                    onmouseover="return overlib('<table width=310px><tr><td class=c>{{ $of_hire_engineer }}</td></tr><tr><th style=text-align:left>{{ $add_premium_officier_engineer }}</th></tr></table>');"
                                    onmouseout="return nd();">
                            </a>
                        </td>
                        <td style="margin: 0 auto;" width="35" class="header">
                            <a href="game.php?page=officier" accesskey="o">
                                <img style="border:0;"
                                    src="{{ $dpath }}premium/geologe_ikon{{ $img_premium_officier_geologist }}.gif"
                                    width="32" height="32" alt="{{ $of_hire_geologist }}"
                        ...
                        <td style="margin: 0 auto;" width="35" class="header">
                            <a href="game.php?page=officier" accesskey="o">
                                <img style="border:0;"
                                    src="{{ $dpath }}premium/technokrat_ikon{{ $img_premium_officier_technocrat }}.gif"
                                    width="32" height="32" alt="{{ $of_hire_technocrat }}"
