...
class MyClass extends XGPCore
{
    ...
    public function myMethod(array $params = []): void
    {
        ...
        echo '<span>YEAH!</span>';
        echo '<br><br>';
        echo '<span style="color:red">Disable this hook in app/config/hooks.php</span>';
        echo '<br><br>';
        echo '<span style="color:red">Disable all hooks in app/config/constants.php and changing define(\'HOOKS_ENABLED\', false);</span>';
        echo '</div>';
    }
}
