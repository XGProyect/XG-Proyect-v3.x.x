...
$lang = [
    ...
    'cr_type' => 'Type',
    'cr_total' => 'Total',
    'cr_technologies' => 'Weapons: %d%% Shields: %d%% Armour: %d%%',
    ...
    'cr_fleet_attack_1' => 'The Attacker fires a total of %d shots at the Defender with a total strength of %d.',
    'cr_fleet_attack_2' => 'The defender\'s shields absorb %d points of damage.',
    'cr_fleet_defs_1' => 'The Defender fires a total of %d shots at the Attacker with a total strength of %d.',
    'cr_fleet_defs_2' => 'The attacker\'s shields absorb %d points of damage.',
    ...
    'cr_stealed_ressources' => 'Total loot: %d metal, %d crystal and %d deuterium.',
    'cr_moonbuilt' => 'The huge amount of metal and glass are functioning and form a lunar satellite in orbit the planet %d [%d:%d:%d]!',
];
