...
class Defense extends XGPCore
{
    ...
    public function build_page()
    {
        ...
        foreach ($this->_lang['tech'] as $Element => $ElementName) {
            if ($Element > 400 && $Element <= 599) {
                if (DevelopmentsLib::isDevelopmentAllowed($this->_current_user, $this->_current_planet, $Element)) {
                    ...
                    if ($CanBuildOne && !parent::$users->isOnVacations($this->_current_user)) {
        ...
        parent::$page->display(parent::$page->parseTemplate(parent::$page->getTemplate('buildings/buildings_defense'), $parse));
    }
