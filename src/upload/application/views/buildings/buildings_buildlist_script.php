    ...
    function t() {
        ...
        if ((ss + 3) < aa) {
            ...
            if (s < 0) {
                ...
                if (1) {
                    blc.innerHTML = h + ":" + m + ":" + s + "<br><a href=game.php?page={current_page}&r={call_            program}&listid=" + pk + "&cmd=" + pm + "&planet=" + pl + ">{bd_cancel}</a>";
                } else {
                    blc.innerHTML = h + ":" + m + ":" + s + "<br><a href=game.php?page={current_page}            &r={c        all_        program}&listid        =" + pk + "&cmd=" + pm + "&planet=" + pl + ">{bd_cancel}</a>";
                }
            }
            pp = pp - 1;
            if (timeout == 1) {
