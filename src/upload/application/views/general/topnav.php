                            ...
                            <td style="margin: 0 auto;" width="35px" class='header'>
                                <a href="game.php?page=officier" accesskey="o">
                                    <img style="border:0;" src="{dpath}premium/commander_ikon{img_premium_officier_commander}.gif" width="32"
                                        ...
                                        onmouseover="return overlib('<table width=390px><tr><td class=c>{of_hire_commander}</td></tr><tr><th style=text-align:left>{add_premium_officier_commander}</th></tr></table>', CENTER, WIDTH, 390, OFFSETY, 20);"
                            ...
                            <td style="margin: 0 auto;" width="35" class="header">
                                <a href="game.php?page=officier" accesskey="o">
                                    <img style="border:0;" src="{dpath}premium/admiral_ikon{img_premium_officier_admiral}.gif" width="32"
                                        ...
                                        onmouseover="return overlib('<table width=400px><tr><td class=c>{of_hire_admiral}</td></tr><tr><th style=text-align:left>{add_premium_officier_admiral}</th></tr></table>', CENTER, WIDTH, 400, OFFSETY, 20);"
                                        onmouseout="return nd();">
                                </a>
                            </td>
                            <td style="margin: 0 auto;" width="35" class="header">
                                <a href="game.php?page=officier" accesskey="o">
                                    <img style="border:0;" src="{dpath}premium/ingenieur_ikon{img_premium_officier_engineer}.gif" width="32"
                                        ...
                                        onmouseover="return overlib('<table width=310px><tr><td class=c>{of_hire_admiral}</td></tr><tr><th style=text-align:left>{add_premium_officier_engineer}</th></tr></table>', CENTER, WIDTH, 310, OFFSETY, 20);"
                                        onmouseout="return nd();">
                                </a>
                            </td>
                            <td style="margin: 0 auto;" width="35" class="header">
                                <a href="game.php?page=officier" accesskey="o">
                                    <img style="border:0;" src="{dpath}premium/geologe_ikon{img_premium_officier_geologist}.gif" width="32"
                                        ...
                                        onmouseover="return overlib('<table width=200px><tr><td class=c>{of_hire_geologist}</td></tr><tr><th style=text-align:left>{add_premium_officier_geologist}</th></tr></table>', CENTER, WIDTH, 200, OFFSETY, 20);"
                                        onmouseout="return nd();">
                                </a>
                            </td>
                            <td style="margin: 0 auto;" width="35" class="header">
                                <a href="game.php?page=officier" accesskey="o">
                                    <img style="border:0;" src="{dpath}premium/technokrat_ikon{img_premium_officier_technocrat}.gif" width="32"
                                        ...
                                        onmouseover="return overlib('<table width=275px><tr><td class=c>{of_hire_technocrat}</td></tr><tr><th style=text-align:left>{add_premium_officier_technocrat}</th></tr></table>', CENTER, WIDTH, 275, OFFSETY, 20);"
                                        onmouseout="return nd();">
                                </a>
                            </td>
                        </tr>
