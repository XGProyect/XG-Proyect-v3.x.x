...
class Messages extends XGPCore
{
    ...
    private function build_page()
    {
        ...
        if (isset($_GET['dsp']) && $_GET['dsp'] == 1 && $this->_have_premium) {
            ...
            foreach ($_GET as $field => $value) {
                if (FunctionsLib::inMultiarray($field, $this->_message_type)) {
                    $type_id = FunctionsLib::recursiveArraySearch($field, $this->_message_type);
        ...
        switch ($mode) {
            case 'write':
                ...
                if ($_POST) {
                    ...
                    if (!$_POST['subject']) {
                        ...
                        $error_page = parent::$page->parseTemplate(parent::$page->getTemplate('messages/messages_error_table'), $parse);
                    }
                ...
                parent::$page->display(parent::$page->parseTemplate(parent::$page->getTemplate('messages/messages_pm_form_view'), $parse));
            ...
            default:
                ...
                parent::$page->display(parent::$page->parseTemplate($this->set_default_template(), $parse));
    ...
    private function load_messages($messages)
    {
        ...
        return parent::$page->parseTemplate(parent::$page->getTemplate('messages/messages_list_container_view'), $parse);
    }
    ...
    {
        return parent::$page->parseTemplate(parent::$page->getTemplate('messages/messages_delete_options_view'), $this->_lang);
    }
